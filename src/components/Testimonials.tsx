  ...
  return (
    <Section id="testimonials">
      <Anim variant="fadeDown">
        <SectionHeader title="客户评价" subtitle="Customer Reviews" />
      </Anim>

      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        {testimonials.map((testimonial, index) => (
          <Anim key={index} variant={index === 0 ? 'fadeLeft' : 'fadeRight'} delay={index * 0.15}>
            <div className="bg-gradient-to-br from-red-50 to-yellow-50 rounded-2xl p-8 shadow-lg border border-red-100">
              <div className="mb-4">
              ...
              <p className="text-gray-800 text-lg mb-3 leading-relaxed">"{testimonial.review}"</p>
              <p className="text-gray-500 text-sm mb-6">"{testimonial.reviewEn}"</p>
