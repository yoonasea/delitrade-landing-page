  ...
  return (
    <Section id="about">
      <Anim variant="fadeDown">
        <SectionHeader title="关于八寶軒" subtitle="About De Li Trade" />
      </Anim>
          ...
          <Anim variant="fadeRight" delay={0.1}>
            <div className="bg-red-50 p-6 rounded-lg border-l-4 border-feng-shui-red">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-feng-shui-red mb-2">专业品质</h3>
                  <p className="text-gray-600">精选优质风水用品，每件产品都经过精心挑选</p>
                  <p className="text-gray-500 text-sm">Premium quality Feng Shui products, carefully selected</p>
                </div>
              </div>
            </div>
          </Anim>
          ...
          <Anim variant="fadeRight" delay={0.2}>
            <div className="bg-yellow-50 p-6 rounded-lg border-l-4 border-feng-shui-gold">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-feng-shui-gold mb-2">贴心服务</h3>
                  <p className="text-gray-600">专业顾问一对一服务，为您量身定制解决方案</p>
                  <p className="text-gray-500 text-sm">Personalized service with dedicated consultants</p>
                </div>
              </div>
            </div>
          </Anim>
          ...
          <Anim variant="fadeRight" delay={0.3}>
            <div className="bg-green-50 p-6 rounded-lg border-l-4 border-feng-shui-green">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-xl font-bold text-feng-shui-green mb-2">传承文化</h3>
                  <p className="text-gray-600">传承中华传统文化，结合现代生活需求</p>
                  <p className="text-gray-500 text-sm">Preserving Chinese traditions with modern applications</p>
                </div>
              </div>
            </div>
          </Anim>
