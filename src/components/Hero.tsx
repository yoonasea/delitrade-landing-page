      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <Anim variant="fadeDown">
          ...
          <div className="flex justify-center mb-6">
            <Sparkles className="text-red-400 w-8 h-8 animate-pulse" />
          </div>
          
          {/* Chinese Name */}
          <h1 className="text-6xl sm:text-7xl md:text-8xl font-bold text-yellow-500 mb-4 tracking-wider">
            八寶軒
          </h1>
        ...
        <Anim variant="fadeUp" delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <a
              href="tel:94317868"
              className="px-8 py-4 border-2 border-amber-700 text-amber-700 hover:bg-amber-700 hover:text-white font-bold rounded-full transition-all transform hover:scale-105 flex items-center gap-2"
            >
              <span>立即咨询</span>
            </a>
          </div>
